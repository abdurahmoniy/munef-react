...
function LanguageSwitcher() {
  ...
  // Update selected language based on the URL pathname
  useEffect(() => {
    if (location.pathname === '/rus') {
      setSelectedLanguage({ flagImage: rusflag, languageText: 'Rus' });
    } else {
      setSelectedLanguage({ flagImage: uzflag, languageText: 'Uzb' });
    }
  }, [location.pathname]);
